                ...
                <div className="relative flex flex-col gap-5">
                    <div className="flex items-center gap-4 flex-1 min-w-0">
                        ...
                        <div className="min-w-0 flex-1">
                            <h4 className="text-base font-black text-neutral-5 truncate tracking-tight">{currentTrack.title}</h4>
                            <p className="text-xs text-neutral-5/70 font-bold truncate opacity-90">{currentTrack.artist}</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {/* Queue indicator */}
                        {queue.length > 0 && (
                            <div className="flex items-center gap-2 text-xs text-neutral-5/70">
                                <IconList size={14} />
                        ...
                        <div className="flex items-center justify-between">
                            <button
                                ...
                                className={cn(
                                    ...
                                    showPlaylist ? "text-primary-400 bg-white/5" : "text-neutral-5/70 hover:text-neutral-5"
                                )}
                            >
                            ...
                            <div className="flex items-center gap-4">
                                <button
                                    ...
                                    className="text-neutral-5/70 hover:text-neutral-5 transition-all hover:scale-110 disabled:opacity-30 disabled:cursor-not-allowed"
                                >
                                    <IconPlayerSkipBack size={20} fill="currentColor" />
                                </button>
                                <button
                                    onClick={() => setIsPlaying(!isPlaying)}
                                    className="w-11 h-11 flex items-center justify-center rounded-full bg-background-500 text-neutral-5 hover:scale-110 transition-all active:scale-95 shadow-lg shadow-black/10 dark:shadow-white/5"
                                >
                            ...
                            <div className="group/volume relative flex items-center gap-2">
                                <IconVolume size={18} className="text-neutral-5/70 group-hover/volume:text-neutral-5 transition-colors" />
                                ...
                                <>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white/5 border border-white/5 rounded-2xl py-3 pl-10 pr-4 text-sm font-medium text-neutral-5 placeholder:text-neutral-5/40 focus:outline-none focus:bg-white/10 focus:border-primary-400/30 transition-all"
                                        />
                                        {searchQuery && (
                                        ...
                                        {filteredSongs.map((song) => (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="text-xs font-black text-neutral-5 truncate">{song.title}</p>
                                                    <p className="text-[10px] text-neutral-5/70 font-bold">{song.artist} • {song.durationLabel}</p>
                                                </div>
                                                <button
                                        ...
                                        <>
                                            ...
                                            {queue.map((song, index) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <p className="text-xs font-black text-neutral-5 truncate">{song.title}</p>
                                                        <p className="text-[10px] text-neutral-5/70 font-bold">{song.artist}</p>
                                                    </div>
                                                    <button
