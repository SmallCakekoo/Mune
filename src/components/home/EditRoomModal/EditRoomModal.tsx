          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className={`flex items-center gap-2 p-4 rounded-xl border-2 transition-all ${privacy === 'public'
                ...
                : 'border-neutral-200 dark:border-white/20 bg-white dark:bg-white/5 text-neutral-5 hover:border-primary-500/30 hover:bg-neutral-50 dark:hover:bg-white/10'
                }`}
              disabled={isSubmitting}
            >
              <IconWorld size={20} />
