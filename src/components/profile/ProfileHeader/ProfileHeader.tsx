        ...
        <div className="relative overflow-hidden rounded-3xl bg-primary-600 p-8 shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8">
                ...
                <div className="flex-1 text-center md:text-left">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-4">
                        {user.socialLinks?.discord && (
                            <div className="flex items-center gap-2 text-white/80 hover:text-white transition-colors bg-white/5 py-1.5 px-3 rounded-lg border border-white/10">
                ...
                <div className="flex gap-4 md:flex-col lg:flex-row">
                    <motion.div
                        whileHover={{ y: -5 }}
                        className="bg-white/10 backdrop-blur-md rounded-2xl p-4 min-w-[140px] text-center border border-white/10"
                    >
                        <p className="text-2xl font-bold text-white">¡{user.stats?.roomsCreated || 0}!</p>
                        <p className="text-xs text-primary-100 uppercase tracking-wider font-semibold">Rooms Created</p>
                    </motion.div>
                    <motion.div
                        whileHover={{ y: -5 }}
                        className="bg-secondary-400 backdrop-blur-md rounded-2xl p-4 min-w-[140px] text-center border border-white/10"
                    >
                        <p className="text-2xl font-bold text-white">¡{user.stats?.minutesSpent || 0}!</p>
                        <p className="text-xs text-white/80 uppercase tracking-wider font-semibold">Minutes here</p>
                    </motion.div>
                </div>
            </div>
        </div>
